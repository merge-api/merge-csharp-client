...
public record CustomObjectClassesCustomObjectsAssociationsListRequest
{
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<CustomObjectClassesCustomObjectsAssociationsListRequestExpandItem> Expand { get; set; } =
        new List<CustomObjectClassesCustomObjectsAssociationsListRequestExpandItem>();
