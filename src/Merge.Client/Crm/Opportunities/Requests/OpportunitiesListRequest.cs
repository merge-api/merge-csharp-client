...
public record OpportunitiesListRequest
{
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<OpportunitiesListRequestExpandItem> Expand { get; set; } =
        new List<OpportunitiesListRequestExpandItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public OpportunitiesListRequestRemoteFields? RemoteFields { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public OpportunitiesListRequestShowEnumOrigins? ShowEnumOrigins { get; set; }
