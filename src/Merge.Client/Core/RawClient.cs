...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<Merge.Client.Core.ApiResponse> MakeRequestAsync(
        Merge.Client.Core.BaseRequest request,
    ...
    internal async Task<Merge.Client.Core.ApiResponse> SendRequestAsync(
        Merge.Client.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<Merge.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new Merge.Client.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(Merge.Client.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(Merge.Client.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use Merge.Client.Core.ApiResponse instead.")]
    internal record ApiResponse : Merge.Client.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use Merge.Client.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : Merge.Client.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Client.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : Merge.Client.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Client.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : Merge.Client.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Client.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : Merge.Client.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Client.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : Merge.Client.Core.StreamRequest;
}
