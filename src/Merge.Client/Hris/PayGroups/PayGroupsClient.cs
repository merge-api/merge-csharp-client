...
public class PayGroupsClient
{
    ...
    /// </summary>
    public async Task<PaginatedPayGroupList> ListAsync(PayGroupsListRequest request)
    {
    ...
    /// </summary>
    public async Task<PayGroup> RetrieveAsync(string id, PayGroupsRetrieveRequest request)
    {
        var _query = new Dictionary<string, object>() { };
        if (request.IncludeRemoteData != null)
        {
