...
public record TimesheetEntriesListRequest
{
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<TimesheetEntriesListRequestExpandItem> Expand { get; set; } =
        new List<TimesheetEntriesListRequestExpandItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public TimesheetEntriesListRequestOrderBy? OrderBy { get; set; }
