...
[Serializable]
public record GeneralLedgerTransactionsListRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GeneralLedgerTransactionsListRequestExpandItem> Expand { get; set; } =
        new List<GeneralLedgerTransactionsListRequestExpandItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public DateTime? PostedDateAfter { get; set; }

    /// <summary>
    /// If provided, will only return objects posted before this datetime.
    /// </summary>
    [JsonIgnore]
    public DateTime? PostedDateBefore { get; set; }
