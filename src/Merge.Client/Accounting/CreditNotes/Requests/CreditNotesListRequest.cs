...
public record CreditNotesListRequest
{
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<CreditNotesListRequestExpandItem> Expand { get; set; } =
        new List<CreditNotesListRequestExpandItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public CreditNotesListRequestRemoteFields? RemoteFields { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public CreditNotesListRequestShowEnumOrigins? ShowEnumOrigins { get; set; }
