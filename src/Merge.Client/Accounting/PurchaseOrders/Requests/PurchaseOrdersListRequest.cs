...
public record PurchaseOrdersListRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<PurchaseOrdersListRequestExpandItem> Expand { get; set; } =
        new List<PurchaseOrdersListRequestExpandItem>();
