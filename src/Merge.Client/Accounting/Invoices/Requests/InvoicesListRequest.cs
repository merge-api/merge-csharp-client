...
public record InvoicesListRequest
{
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<InvoicesListRequestExpandItem> Expand { get; set; } =
        new List<InvoicesListRequestExpandItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public InvoicesListRequestRemoteFields? RemoteFields { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public InvoicesListRequestShowEnumOrigins? ShowEnumOrigins { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public InvoicesListRequestStatus? Status { get; set; }
