...
public class InvoicesListRequest
{
    /// <summary>
    ...
    /// </summary>
    public InvoicesListRequestExpand? Expand { get; init; }
    ...
    /// If provided, will only return objects created after this datetime.
    /// </summary>
    public DateTime? IssueDateAfter { get; init; }

    /// <summary>
    /// If provided, will only return objects created before this datetime.
    /// </summary>
    public DateTime? IssueDateBefore { get; init; }
    ...
    /// </summary>
    public InvoicesListRequestType? Type { get; init; }
}
