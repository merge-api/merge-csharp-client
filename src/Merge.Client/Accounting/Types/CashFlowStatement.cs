...
public class CashFlowStatement
{
    ...
    public List<ReportItem>? OperatingActivities { get; init; }

    [JsonPropertyName("investing_activities")]
    public List<ReportItem>? InvestingActivities { get; init; }

    [JsonPropertyName("financing_activities")]
    public List<ReportItem>? FinancingActivities { get; init; }
