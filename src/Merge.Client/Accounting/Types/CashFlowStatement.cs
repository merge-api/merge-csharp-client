...
public class CashFlowStatement
{
    ...
    /// </summary>
    [JsonPropertyName("cash_at_beginning_of_period")]
    public double? CashAtBeginningOfPeriod { get; init; }

    /// <summary>
    /// Cash and cash equivalents at the beginning of the cash flow statement's period.
    /// </summary>
    [JsonPropertyName("cash_at_end_of_period")]
    public double? CashAtEndOfPeriod { get; init; }

    [JsonPropertyName("operating_activities")]
    public IEnumerable<ReportItem>? OperatingActivities { get; init; }

    [JsonPropertyName("investing_activities")]
    public IEnumerable<ReportItem>? InvestingActivities { get; init; }

    [JsonPropertyName("financing_activities")]
    public IEnumerable<ReportItem>? FinancingActivities { get; init; }

    /// <summary>
    /// The time that cash flow statement was generated by the accounting system.
    /// </summary>
    [JsonPropertyName("remote_generated_at")]
    public DateTime? RemoteGeneratedAt { get; init; }
