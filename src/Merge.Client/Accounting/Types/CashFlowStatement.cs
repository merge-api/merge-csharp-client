...
public record CashFlowStatement
{
    ...
    public IEnumerable<ReportItem>? OperatingActivities { get; set; }

    [JsonAccess(JsonAccessType.ReadOnly)]
    [JsonPropertyName("investing_activities")]
    public IEnumerable<ReportItem>? InvestingActivities { get; set; }

    [JsonAccess(JsonAccessType.ReadOnly)]
    [JsonPropertyName("financing_activities")]
    public IEnumerable<ReportItem>? FinancingActivities { get; set; }
