...
public record GeneralLedgerTransactionLine
{
    ...
    public TransactionCurrencyEnum? BaseCurrency { get; set; }
    ...
    [JsonPropertyName("foreign_debit_amount")]
    public required string ForeignDebitAmount { get; set; }

    [JsonPropertyName("foreign_credit_amount")]
