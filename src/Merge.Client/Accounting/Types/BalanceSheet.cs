...
public class BalanceSheet
{
    ...
    public double? NetAssets { get; init; }

    [JsonPropertyName("assets")]
    public IEnumerable<ReportItem>? Assets { get; init; }

    [JsonPropertyName("liabilities")]
    public IEnumerable<ReportItem>? Liabilities { get; init; }

    [JsonPropertyName("equity")]
    public IEnumerable<ReportItem>? Equity { get; init; }
