...
public class RejectReasonsClient
{
    ...
    public RejectReasonsClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    public async Task<PaginatedRejectReasonList> ListAsync(RejectReasonsListRequest request)
    {
    ...
    /// </summary>
    public async Task<RejectReason> RetrieveAsync(string id, RejectReasonsRetrieveRequest request)
    {
        var _query = new Dictionary<string, object>() { };
        if (request.IncludeRemoteData != null)
        {
