...
[Serializable]
public record InterviewsListRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<InterviewsListRequestExpandItem> Expand { get; set; } =
        new List<InterviewsListRequestExpandItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public string? JobInterviewStageId { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public InterviewsListRequestRemoteFields? RemoteFields { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public InterviewsListRequestShowEnumOrigins? ShowEnumOrigins { get; set; }
