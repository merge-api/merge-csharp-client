...
public partial class ScopesClient
{
    ...
    ///     {
    ///         CommonModels = new List&lt;Merge.Ats.IndividualCommonModelScopeDeserializerRequest&gt;()
    ///         {
    ///             new Merge.Ats.IndividualCommonModelScopeDeserializerRequest
    ///             {
    ///                 ModelName = "Employee",
    ...
    ///                     {
    ///                         "READ",
    ///                         new Merge.Ats.ModelPermissionDeserializerRequest { IsEnabled = true }
    ///                     },
    ///                     {
    ///                         "WRITE",
    ///                         new Merge.Ats.ModelPermissionDeserializerRequest { IsEnabled = false }
    ///                     },
    ///                 },
    ///                 FieldPermissions = new Merge.Ats.FieldPermissionDeserializerRequest
    ///                 {
