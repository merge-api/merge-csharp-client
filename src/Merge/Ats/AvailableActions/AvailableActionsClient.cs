...
namespace Merge.Ats.AvailableActions;
...
public partial class AvailableActionsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Ats.AvailableActions> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Ats.AvailableActions>(responseBody)!;
                    }
