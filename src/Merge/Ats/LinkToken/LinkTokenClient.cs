...
public partial class LinkTokenClient
{
    ...
    ///         Categories = new List&lt;Merge.Ats.CategoriesEnum&gt;()
    ///         {
    ///             Merge.Ats.CategoriesEnum.Hris,
    ///             Merge.Ats.CategoriesEnum.Ats,
    ///         },
    ///     }
    /// );
    /// </code></example>
    public async Task<Merge.Ats.LinkToken> CreateAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Ats.LinkToken>(responseBody)!;
                    }
