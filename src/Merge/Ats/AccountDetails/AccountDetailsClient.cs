...
namespace Merge.Ats.AccountDetails;
...
public partial class AccountDetailsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Ats.AccountDetails> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Ats.AccountDetails>(responseBody)!;
                    }
