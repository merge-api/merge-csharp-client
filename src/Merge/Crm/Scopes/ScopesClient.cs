...
public partial class ScopesClient
{
    ...
    ///     {
    ///         CommonModels = new List&lt;Merge.Crm.IndividualCommonModelScopeDeserializerRequest&gt;()
    ///         {
    ///             new Merge.Crm.IndividualCommonModelScopeDeserializerRequest
    ///             {
    ///                 ModelName = "Employee",
    ...
    ///                     {
    ///                         "READ",
    ///                         new Merge.Crm.ModelPermissionDeserializerRequest { IsEnabled = true }
    ///                     },
    ///                     {
    ///                         "WRITE",
    ///                         new Merge.Crm.ModelPermissionDeserializerRequest { IsEnabled = false }
    ///                     },
    ///                 },
    ///                 FieldPermissions = new Merge.Crm.FieldPermissionDeserializerRequest
    ///                 {
