...
namespace Merge.Crm.AsyncPassthrough;
...
public partial class AsyncPassthroughClient
{
    ...
    ///     new Merge.Crm.DataPassthroughRequest { Method = Merge.Crm.MethodEnum.Get, Path = "/scooters" }
    /// );
    /// </code></example>
