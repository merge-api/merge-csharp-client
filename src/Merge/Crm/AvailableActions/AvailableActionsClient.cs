...
namespace Merge.Crm.AvailableActions;
...
public partial class AvailableActionsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Crm.AvailableActions> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Crm.AvailableActions>(responseBody)!;
                    }
