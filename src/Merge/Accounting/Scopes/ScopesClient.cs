...
namespace Merge.Accounting.Scopes;
...
public partial class ScopesClient
{
    ...
    ///     {
    ///         CommonModels = new List&lt;Merge.Accounting.IndividualCommonModelScopeDeserializerRequest&gt;()
    ///         {
    ///             new Merge.Accounting.IndividualCommonModelScopeDeserializerRequest
    ///             {
    ///                 ModelName = "Employee",
    ...
    ///                     {
    ///                         "READ",
    ///                         new Merge.Accounting.ModelPermissionDeserializerRequest { IsEnabled = true }
    ///                     },
    ///                     {
    ///                         "WRITE",
    ///                         new Merge.Accounting.ModelPermissionDeserializerRequest
    ///                         {
    ///                             IsEnabled = false,
    ///                         }
    ///                     },
    ///                 },
    ///                 FieldPermissions = new Merge.Accounting.FieldPermissionDeserializerRequest
    ///                 {
