...
namespace Merge.Accounting.AvailableActions;
...
public partial class AvailableActionsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Accounting.AvailableActions> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Accounting.AvailableActions>(
                            responseBody
                        )!;
                    }
