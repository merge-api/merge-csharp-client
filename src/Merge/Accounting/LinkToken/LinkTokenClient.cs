...
namespace Merge.Accounting.LinkToken;
...
public partial class LinkTokenClient
{
    ...
    ///         Categories = new List&lt;Merge.Accounting.CategoriesEnum&gt;()
    ///         {
    ///             Merge.Accounting.CategoriesEnum.Hris,
    ///             Merge.Accounting.CategoriesEnum.Ats,
    ///         },
    ///     }
    /// );
    /// </code></example>
    public async Task<Merge.Accounting.LinkToken> CreateAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Accounting.LinkToken>(responseBody)!;
                    }
