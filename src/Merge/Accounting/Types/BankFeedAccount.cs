...
public record BankFeedAccount
{
    ...
    /// </summary>
    [JsonPropertyName("source_account_name")]
    ...
    /// </summary>
    [JsonPropertyName("target_account_name")]
    ...
    public IEnumerable<object>? RemoteData { get; set; }
