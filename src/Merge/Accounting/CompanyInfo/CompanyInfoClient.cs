...
public partial class CompanyInfoClient
{
    ...
    internal CompanyInfoClient(RawClient client)
    {
        _client = client;
    }
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<PaginatedCompanyInfoList>(responseBody)!;
                    }
    ...
    /// </code></example>
    public async Task<Pager<Merge.Accounting.CompanyInfo>> ListAsync(
        CompanyInfoListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public async Task<Merge.Accounting.CompanyInfo> RetrieveAsync(
        string id,
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Accounting.CompanyInfo>(responseBody)!;
                    }
                    catch (JsonException e)
                    {
                        throw new MergeException("Failed to deserialize response", e);
