...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<Merge.Core.ApiResponse> MakeRequestAsync(
        Merge.Core.BaseRequest request,
    ...
    internal async Task<Merge.Core.ApiResponse> SendRequestAsync(
        Merge.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<Merge.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new Merge.Core.ApiResponse
            {
        ...
        return new Merge.Core.ApiResponse { StatusCode = (int)response.StatusCode, Raw = response };
    }
    ...
    internal HttpRequestMessage CreateHttpRequest(Merge.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(Merge.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use Merge.Core.ApiResponse instead.")]
    internal record ApiResponse : Merge.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use Merge.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : Merge.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : Merge.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : Merge.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : Merge.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use Merge.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : Merge.Core.StreamRequest;
}
