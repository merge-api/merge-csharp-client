...
namespace Merge.Hris.AvailableActions;
...
public partial class AvailableActionsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Hris.AvailableActions> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Hris.AvailableActions>(responseBody)!;
                    }
