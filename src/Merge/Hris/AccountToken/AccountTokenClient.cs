...
namespace Merge.Hris.AccountToken;
...
public partial class AccountTokenClient
{
    ...
    /// </code></example>
    public async Task<Merge.Hris.AccountToken> RetrieveAsync(
        string publicToken,
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Hris.AccountToken>(responseBody)!;
                    }
