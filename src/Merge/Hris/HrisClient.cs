using Merge.Core;
using Merge.Hris.AccountDetails;
using Merge.Hris.AccountToken;
using Merge.Hris.AsyncPassthrough;
using Merge.Hris.AuditTrail;
using Merge.Hris.AvailableActions;
using Merge.Hris.BankInfo;
using Merge.Hris.Benefits;
using Merge.Hris.Companies;
using Merge.Hris.DeleteAccount;
using Merge.Hris.Dependents;
using Merge.Hris.EmployeePayrollRuns;
using Merge.Hris.Employees;
using Merge.Hris.EmployerBenefits;
using Merge.Hris.Employments;
using Merge.Hris.FieldMapping;
using Merge.Hris.ForceResync;
using Merge.Hris.GenerateKey;
using Merge.Hris.Groups;
using Merge.Hris.Issues;
using Merge.Hris.LinkedAccounts;
using Merge.Hris.LinkToken;
using Merge.Hris.Locations;
using Merge.Hris.Passthrough;
using Merge.Hris.PayGroups;
using Merge.Hris.PayrollRuns;
using Merge.Hris.RegenerateKey;
using Merge.Hris.Scopes;
using Merge.Hris.SyncStatus;
using Merge.Hris.Teams;
using Merge.Hris.TimeOff;
using Merge.Hris.TimeOffBalances;
using Merge.Hris.TimesheetEntries;
using Merge.Hris.WebhookReceivers;
