...
namespace Merge.Hris.AccountDetails;
...
public partial class AccountDetailsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Hris.AccountDetails> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Hris.AccountDetails>(responseBody)!;
                    }
