...
namespace Merge.Hris.LinkToken;
...
public partial class LinkTokenClient
{
    ...
    ///         Categories = new List&lt;Merge.Hris.CategoriesEnum&gt;()
    ///         {
    ///             Merge.Hris.CategoriesEnum.Hris,
    ///             Merge.Hris.CategoriesEnum.Ats,
    ///         },
    ///     }
    /// );
    /// </code></example>
    public async Task<Merge.Hris.LinkToken> CreateAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Hris.LinkToken>(responseBody)!;
                    }
