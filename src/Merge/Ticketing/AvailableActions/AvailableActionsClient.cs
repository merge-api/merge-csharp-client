...
namespace Merge.Ticketing.AvailableActions;
...
public partial class AvailableActionsClient
{
    ...
    /// </code></example>
    public async Task<Merge.Ticketing.AvailableActions> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Ticketing.AvailableActions>(
                            responseBody
                        )!;
                    }
