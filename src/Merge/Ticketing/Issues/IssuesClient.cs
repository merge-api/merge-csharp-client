...
namespace Merge.Ticketing.Issues;
    ...
    )
    {
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                {
                    _query["first_incident_time_after"] =
                        request.FirstIncidentTimeAfter.Value.ToString(Constants.DateTimeFormat);
                }
                if (request.FirstIncidentTimeBefore != null)
                {
                    _query["first_incident_time_before"] =
                        request.FirstIncidentTimeBefore.Value.ToString(Constants.DateTimeFormat);
                }
                ...
                {
                    _query["last_incident_time_after"] =
                        request.LastIncidentTimeAfter.Value.ToString(Constants.DateTimeFormat);
                }
                if (request.LastIncidentTimeBefore != null)
                {
                    _query["last_incident_time_before"] =
                        request.LastIncidentTimeBefore.Value.ToString(Constants.DateTimeFormat);
                }
