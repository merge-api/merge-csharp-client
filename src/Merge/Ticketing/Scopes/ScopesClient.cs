...
namespace Merge.Ticketing.Scopes;
...
public partial class ScopesClient
{
    ...
    ///     {
    ///         CommonModels = new List&lt;Merge.Ticketing.IndividualCommonModelScopeDeserializerRequest&gt;()
    ///         {
    ///             new Merge.Ticketing.IndividualCommonModelScopeDeserializerRequest
    ///             {
    ///                 ModelName = "Employee",
    ...
    ///                     {
    ///                         "READ",
    ///                         new Merge.Ticketing.ModelPermissionDeserializerRequest { IsEnabled = true }
    ///                     },
    ///                     {
    ///                         "WRITE",
    ///                         new Merge.Ticketing.ModelPermissionDeserializerRequest { IsEnabled = false }
    ///                     },
    ///                 },
    ///                 FieldPermissions = new Merge.Ticketing.FieldPermissionDeserializerRequest
    ///                 {
