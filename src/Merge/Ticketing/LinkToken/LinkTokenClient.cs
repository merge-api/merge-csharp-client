...
namespace Merge.Ticketing.LinkToken;
...
public partial class LinkTokenClient
{
    ...
    ///         Categories = new List&lt;Merge.Ticketing.CategoriesEnum&gt;()
    ///         {
    ///             Merge.Ticketing.CategoriesEnum.Hris,
    ///             Merge.Ticketing.CategoriesEnum.Ats,
    ///         },
    ///     }
    /// );
    /// </code></example>
    public async Task<Merge.Ticketing.LinkToken> CreateAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.Ticketing.LinkToken>(responseBody)!;
                    }
