...
namespace Merge.FileStorage.Scopes;
...
public partial class ScopesClient
{
    ...
    ///     {
    ///         CommonModels = new List&lt;Merge.FileStorage.IndividualCommonModelScopeDeserializerRequest&gt;()
    ///         {
    ///             new Merge.FileStorage.IndividualCommonModelScopeDeserializerRequest
    ///             {
    ///                 ModelName = "Employee",
    ...
    ///                     {
    ///                         "READ",
    ///                         new Merge.FileStorage.ModelPermissionDeserializerRequest
    ///                         {
    ///                             IsEnabled = true,
    ///                         }
    ///                     },
    ...
    ///                     },
    ///                 },
    ///                 FieldPermissions = new Merge.FileStorage.FieldPermissionDeserializerRequest
    ///                 {
