...
namespace Merge.FileStorage.AccountDetails;
...
public partial class AccountDetailsClient
{
    ...
    /// </code></example>
    public async Task<Merge.FileStorage.AccountDetails> RetrieveAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.FileStorage.AccountDetails>(
                            responseBody
                        )!;
                    }
