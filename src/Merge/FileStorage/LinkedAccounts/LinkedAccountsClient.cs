...
namespace Merge.FileStorage.LinkedAccounts;
    ...
    )
    {
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                {
                    _query["include_duplicates"] = JsonUtils.Serialize(
                        request.IncludeDuplicates.Value
                    );
                }
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<PaginatedAccountDetailsAndActionsList>(
                            responseBody
                        )!;
                    }
