...
namespace Merge.FileStorage.LinkToken;
...
public partial class LinkTokenClient
{
    ...
    ///         Categories = new List&lt;Merge.FileStorage.CategoriesEnum&gt;()
    ///         {
    ///             Merge.FileStorage.CategoriesEnum.Hris,
    ///             Merge.FileStorage.CategoriesEnum.Ats,
    ///         },
    ///     }
    /// );
    /// </code></example>
    public async Task<Merge.FileStorage.LinkToken> CreateAsync(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        return JsonUtils.Deserialize<Merge.FileStorage.LinkToken>(responseBody)!;
                    }
