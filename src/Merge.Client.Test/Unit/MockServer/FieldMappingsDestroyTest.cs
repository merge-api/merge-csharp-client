...
[TestFixture]
public class FieldMappingsDestroyTest : BaseMockServerTest
{
    [Test]
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/ticketing/v1/field-mappings/field_mapping_id")
                    .UsingDelete()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Ticketing.FieldMapping.FieldMappingsDestroyAsync(
            "field_mapping_id"
        );
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<Ticketing.FieldMappingInstanceResponse>(mockResponse))
                .UsingDefaults()
        );
    }
}
