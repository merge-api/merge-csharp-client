...
[TestFixture]
public class MetaPatchRetrieveTest : BaseMockServerTest
{
    [Test]
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/ticketing/v1/tickets/meta/patch/id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Ticketing.Tickets.MetaPatchRetrieveAsync("id");
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<Ticketing.MetaResponse>(mockResponse)).UsingDefaults()
        );
    }
}
