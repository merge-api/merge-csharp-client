...
[TestFixture]
public class CustomObjectClassesAssociationTypesMetaPostRetrieveTest : BaseMockServerTest
{
    [Test]
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<Crm.MetaResponse>(mockResponse)).UsingDefaults()
        );
    }
}
